  ...
  return (
    <main className="flex flex-col items-start w-full h-full lg:min-h-screen p-[10px] lg:p-[20px_100px]">
      ...
      <div className="border box-shad flex flex-col-reverse lg:flex-row items-start w-full mt-[20px]  rounded-[16px] gap-[20px] lg:h-[500px]">
        <div className="w-full lg:w-[60%] min-h-full flex flex-col items-start justify-center  px-[15px] lg:px-[30px]">
          <p className="text-[#FFFF01] font-nick uppercase text-[24px] lg:text-[40px]">
            Lamps on Blast⚡
          </p>
          <p className="w-[90%] text-[20px] font-manrope leading-[32px]">
            Empowering the trillion dollar blockchain economy with lightning
            speed multichain trading tools.
          </p>
          <p className="font-manrope mt-[20px] text-[20px]">V.1 coming soon on <span className="font-[800]">Blast️</span></p>
          <div className="mt-[40px] w-full grid lg:grid-cols-2 items-center gap-[40px] mb-[50px] lg:mb-0">
            <div>
        ...
        <div className="w-full lg:w-[40%]   rounded-t-[16px] lg:rounded-t-none lg:rounded-r-[16px]">
          <Image src={pic} className="lg:h-[500px] rounded-t-[16px] lg:rounded-t-none lg:rounded-r-[16px]" alt="pic" />
        </div>
      </div>
    </main>
  );
